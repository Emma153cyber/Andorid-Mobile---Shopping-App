    ...
    if (_imageList.length >= 4) {
      ...
      return showDialog(
        builder: (context) => const SimpleDialog(
          ...
          children: <Widget>[
            Center(
              child: Text("Maximum number of attach image is 4"),
            ),
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Row(// get images from gallery and/or camera
                    children: <Widget>[
                      ...
                      IconButton(
                        ...
                        onPressed: (_currImageList.length >= 4
                            ? null
                            : () {
                                getImage('gallery');
                              }),
                  ...
                  ElevatedButton(
                    ...
                    onPressed: (emptyTitle || emptyPrice
                        ? () {
                    ...
                    children: <Widget>[
                      SizedBox(
                        ...
                        // PickedImage(image: _currImage)
                            : const Text("You can add at most 4 images"),
                      ),
                    ],
                  ),
                ],
